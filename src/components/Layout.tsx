...
const RELAY_GROUPS: { heading: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { to: '/relay/users', label: 'Users', icon: 'users' },
      { to: '/relay/subscribers', label: 'Subscribers', icon: 'subscriptions' },
      { to: '/relay/billing', label: 'Billing activity', icon: 'audit' },
      { to: '/relay/analytics', label: 'Analytics', icon: 'analytics' },
      { to: '/relay/devices', label: 'Devices', icon: 'health' },
